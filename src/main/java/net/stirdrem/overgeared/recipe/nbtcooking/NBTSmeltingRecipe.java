...
public class NBTSmeltingRecipe extends AbstractNBTCookingRecipe {
    ...
    public NBTSmeltingRecipe(Identifier id, String group, CookingRecipeCategory category,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.NBT_ADD_SMELTING;
    }
    ...
    public static class Serializer implements RecipeSerializer<NBTSmeltingRecipe> {
        ...
        @Override
        public NBTSmeltingRecipe read(Identifier id, JsonObject json) {
        ...
        @Override
        public NBTSmeltingRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, NBTSmeltingRecipe recipe) {
