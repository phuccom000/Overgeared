...
public class StoneAnvilCategory implements IRecipeCategory<ExplanationRecipe> {
    ...
    public StoneAnvilCategory(IGuiHelper guiHelper, DynamicRegistryManager registryManager) {
        ...
        this.title = Text.translatable("jei.overgeared.category.stone_anvil");
    ...
    public void draw(ExplanationRecipe recipe, IRecipeSlotsView recipeSlotsView, DrawContext guiGraphics, double mouseX, double mouseY) {
        ...
        renderWrappedText(
                guiGraphics,
                Text.translatable("jei.overgeared.stone_anvil.description1"),
                textX, textY,
                textWidth,
